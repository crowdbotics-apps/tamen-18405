...
admin.site.site_header = "Tamen"
admin.site.site_title = "Tamen Admin Portal"
admin.site.index_title = "Tamen Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Tamen API",
        default_version="v1",
        description="API documentation for Tamen App",
    ),
    public=True,
